...
//       });
    ...
    //automatically refresh after every 1000 milliseconds.
      ...
      window.setInterval(function(){
      	 $.post("<?php echo base_url();?>get_chat_people",{'company_id':<?php echo $global_company_id;?>,'user_id':<?php echo $global_user_id;?>},function(data){
