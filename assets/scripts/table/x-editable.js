(function($) {
  ...
  $.fn.editabletypes.contact.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
	  tpl:  '<div class="editable-contact"><label><span>First Name : </span><input type="text" name="first_name" class="form-control"></label></div>' +
	  	'<div class="editable-contact"><label><span>Last Name : </span><input type="text" name="last_name" class="form-control"></label></div>' +
		'<div class="editable-contact"><label><span>Mobile No. : </span><input type="text" name="mobile" class="form-control"></label></div>' +
		'<div class="editable-contact"><label><span>Email Address : </span><input type="text" name="email" class="form-control"></label></div>' ,
  ...
  $('#address').editable({
    ...
    display: function(value) {
      ...
      var html =   $('<div>').text(value.location).html()+ ' ' + $('<div>').text(value.street).html() + ' ' + $('<div>').text(value.building).html() + ' ' +  $('<div>').text(value.city).html()+ ' ' +  $('<div>').text(value.state).html()+ ' ' +  $('<div>').text(value.postal_code).html() ;
  ...
  $('#contact').editable({
	  ...
	  display: function(value) {
		  ...
		  var html =  $('<div>').text(value.first_name).html()+ ' ' +  $('<div>').text(value.last_name).html()+ ' ' +$('<div>').text(value.mobile).html() + ' ' + $('<div>').text(value.email).html() ;
		  $(this).html(html);
	  }
  });
