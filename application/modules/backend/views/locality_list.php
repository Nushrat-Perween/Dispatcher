...
<H2>List Of Locality</H2>
</div>
<a href="<?php echo base_url();?>admin/add_locality"><button class="btn bg-primary btn-sm pull-right no-radius">
<i class="fa fa-plus" aria-hidden="true"> </i> Locality
</button></a>
<br>
<br>
...
<a href="<?php echo base_url();?>admin/edit_locality/<?php echo $row['id'];?>" class="bg-green">&nbsp;&nbsp;<i class="fa fa-pencil text-white"></i>&nbsp;Edit&nbsp;&nbsp;</a>
</td>
