  ...
  <div class="content">
    ...
    <div class="content-container">
      <div class="content-header">
        <h2 class="content-header-title"> User List <a href="<?php echo base_url();?>admin/add_user"><button class="btn bg-primary btn-sm pull-right no-radius">
...
<th>Action </th>
             ...
             <?php
				...
				<td> <?php if($row['user_role']==2) { echo "Site User"; } else { echo "Client" ; } ?> </td>
				...
				<a href="<?php echo base_url();?>admin/edit_user/<?php echo $row['id'];?>" class="bg-green" style="margin:2px">&nbsp;&nbsp;<i class="fa fa-pencil text-white"></i>&nbsp;Edit&nbsp;&nbsp;</a>
				</td>
