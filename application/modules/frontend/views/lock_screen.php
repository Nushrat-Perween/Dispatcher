...
<form role="form" action="<?php echo base_url();?>unlock" method="POST">
<input type="password" class="form-control b-a-0 m-b-1" id="password" name="password" placeholder="Password"/>
<input type="hidden" class="form-control b-a-0 m-b-1" id="global_password" name="global_password" value="<?php echo $global_password;?>" placeholder="Password"/>
