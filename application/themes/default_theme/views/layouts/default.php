...
function ajaxindicatorstart(text)
{
	...
	jQuery('body').append('<div id="resultLoading" style="display:none"><div><img src="<?php echo base_url();?>assets/images/icons/loading.gif" alt="Loading data"><div>'+text+'</div></div><div class="bg"></div></div>');
	}
